    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div>
        ...
        <input
          ...
          className="mt-1 focus:ring-2 focus:ring-indigo-300 focus:border-indigo-600 block w-full bg-gray-50 px-3 py-2 shadow-sm sm:text-sm border border-gray-200 rounded-lg placeholder-gray-400"
        />
      </div>
